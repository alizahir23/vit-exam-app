...
const Test = (props) => {
  ...
  useEffect(() => {
    ...
    fetch(
      "https://vit-vellore.herokuapp.com/student/getQuestions/getAllQuestions",
      requestOptions
    )
      ...
      {questionList && !Submited && (
        <div>
          ...
          <div className={styles.question}>
            ...
            <h4>Correct Option: A</h4>
            <h4>Selected Option: C</h4>
          ...
          <button onClick={submitResponse} className={styles.submit}>
            Submit
          </button>
        </div>
      )}
